	...
	private static function social_oauth_brand_glyph_svg( $slug ) {
		...
		switch ( $slug ) {
			...
			case 'discord':
				...
				break;
			case 'patreon':
				$svg .= '<path fill="currentColor" d="M15.386.524c-4.637 0-8.6 3.271-9.63 7.622-.31 1.284-.388 2.614-.388 3.943v10.911h4.537V12.06c0-2.682 2.207-4.858 4.93-4.858s4.93 2.176 4.93 4.858v11.94h4.537V11.09c0-5.7-4.65-10.566-10.516-10.566z"/>';
				break;
			case 'mastodon':
