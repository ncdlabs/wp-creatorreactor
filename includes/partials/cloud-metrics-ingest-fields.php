		...
		<table class="form-table">
			<tr>
				...
				<td>
					...
					<p class="description"><?php esc_html_e( 'Resolved base URL for POST /v1/ingest (scheduled sync completion events). Set CREATORREACTOR_METRICS_INGEST_URL in the server environment, or configure the stored URL at install time; this field is not editable here.', 'creatorreactor' ); ?></p>
				</td>
			</tr>
			<tr>
