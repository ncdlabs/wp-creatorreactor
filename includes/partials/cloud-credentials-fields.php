...
<div class="creatorreactor-settings-block">
	<table class="form-table">
		<tr>
			<th scope="row"><?php esc_html_e( 'Active', 'wp-creatorreactor' ); ?></th>
			<td>
				...
				<label>
					...
					<?php esc_html_e( 'Enable CreatorReactor Cloud', 'wp-creatorreactor' ); ?>
				</label>
				<p class="description"><?php esc_html_e( 'Checked means installed/enabled. Unchecked means uninstalled/disabled.', 'wp-creatorreactor' ); ?></p>
			</td>
		</tr>
		<tr>
			<th scope="row"><?php esc_html_e( 'Your CreatorReactor ID', 'wp-creatorreactor' ); ?></th>
			<td>
		...
		<tr>
			<th scope="row"><?php esc_html_e( 'CreatorReactor Password', 'wp-creatorreactor' ); ?></th>
			<td>
