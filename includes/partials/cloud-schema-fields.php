...
<div class="creatorreactor-cloud-configuration">
	<div class="creatorreactor-settings-block">
		<table class="form-table">
			<tr>
				<th scope="row"><label for="creatorreactor_schema_service_url"><?php esc_html_e( 'Schema Service URL', 'creatorreactor' ); ?></label></th>
				<td>
					...
					<p class="description"><?php esc_html_e( 'Base URL of the Schema Service API (from your browser, local stack is often http://localhost:18080). Server-side PHP in Docker/Podman should use the in-network URL via env CREATORREACTOR_SCHEMA_SERVICE_URL (see compose.yaml) or set that URL here.', 'creatorreactor' ); ?></p>
				</td>
			</tr>
		</table>
	</div>
