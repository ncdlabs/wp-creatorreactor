...
class Login_Page {
	...
	public static function filter_login_message_fanvue_oauth( $message ) {
		...
		$map = [
			...
			'oauth_client'   => __( 'Fanvue rejected the OAuth client. Check Client ID and Client Secret in CreatorReactor settings and that the Fanvue app is active.', 'creatorreactor' ),
			...
			'token'   => __( 'Fanvue did not return a usable token. Check OAuth Client ID, Secret, and redirect URLs in CreatorReactor settings, then try again.', 'creatorreactor' ),
